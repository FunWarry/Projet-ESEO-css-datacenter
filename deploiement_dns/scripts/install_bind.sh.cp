...
echo "Mise à jour du système et installation de BIND9 et dnsutils"
...
echo " Modification de named.conf.options."
...
echo " Vérification de la configuration de BIND..."
named-checkconf

# Configuration  de named.conf.local
echo " Modification  de named.conf.local..."
...
echo "Création et modification  du fichier de zone db.dns.local..."
...
sudo nano /etc/bind/db.reverse.dns.local

echo "Création et modification  du fichier de zone db.reverse.dns.local..."
...
# Création et modification du fichier de zone (db.dns.local)
echo "Création et modification  du fichier /etc/default/named"
...
echo "Vérification de la zone DNS..."
